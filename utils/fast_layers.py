import numpy as np
try:
  from util.im2col_cython import col2im_cython, im2col_cython
  from util.im2col_cython import col2im_6d_cython
except ImportError:
  print('run the following from the util directory and try again:')
